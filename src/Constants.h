...
#define ROOF_45_ANGLE 55
#define ROOF_45_FINAL_ANGLE 50
#define ROOF_45_LIFTED_ANGLE 70
#define ROOF_45_REPLACEMENT_APPROACH_ANGLE 82
...
#define LIFT_ANGLE_AT_DROPOFF 2
#define LIFT_ANGLE_AT_PICKUP 1
#define LIFT_ANGLE_AT_PICKUP_2 0 // Used to account for variatios in field element size
